...
主に飲食店向けに以下の総合サポートサービスを提供する。
1.売り上げ向上につながるサービス
2.無断キャンセルによる予期せぬ被害を最小限に抑えるための店舗用の保険サービス
3.SNSによる風評被害を最小限に食い止めるサービス
<!--
現状たくさんの予約サービスがあり、それ単体では対抗できないかもしれませんが、
店側の立場を優先させた様々なサービスがひとまとめにしたものを提供できれば、まだまだ入り込む余地があるのではないかと思いました。
-->
...
飲食店を含む接客業務が発生する店舗かつ、  
チェーン店のようなノウハウを持った店舗よりも個人経営しているような小さな店をターゲットとする。
<!--
現状たくさんの予約サービスがあり、それ単体では対抗できないかもしれませんが、
店側の立場を優先させた様々なサービスがひとまとめにしたものを提供できれば、まだまだ入り込む余地があるのではないかと思いました。
-->
...
<!-- 誕生日月用のサービスなど -->
---
### 2.無断キャンセルなどによる予期せぬ被害を最小限に抑えるための店舗用の保険サービス
- 事前支払い(前金)サービス  
...
---
- 無断キャンセル、休店補填サービス
無断キャンセル急な休店などが発生した時、想定された損害額の何割かを店側に支払う。
